<form action="keycontact1.php" method="POST">
  <html>
    <head>
...
$sql="INSERT INTO $tbl_name( BuildingName, BuildingNameAr, BuildingType,DSP, FDUNumber, PhoneBoxNum, propertyId, BuildingClass, BlocksNumber, FLoorNumber,ApartmentNumber,Salesperson,datecreated)VALUES('$BuildingName', '$BuildingNameAr', '$BuildingType','$DSP', '$FDUNumber', '$PhoneBoxNum', '$propertyId', '$BuildingClass', '$BlocksNumber', '$FLoorNumber', '$ApartmentNumber','$Salesperson ','$datecreated')";
$result=mysql_query($sql);
if($result){
echo "Successful";
}
else {
 echo "<a href='login-home.php'>Return Home</a>";
die(" connection error: " . mysql_error());
...
GPS Coordinations: &ensp; <input type="text" size="46" id="GPSCoodinations" name="GPSCoodinations" required ><br><br>
